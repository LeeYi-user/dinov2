...
from dinov2.data.transforms_cells import NormalizationType, make_classification_eval_cell_transform
...
from dinov2.eval.utils_celldino import (
    BagOfChannelsModelWithNormalize,
    extract_features_celldino,
    average_metrics,
...
from dinov2.eval.knn import KnnModule, DictKeysModule
...
def eval_knn(
    ...
    for try_n, dataset in train_dataset_dict.items():
        features, labels = extract_features_celldino(model, dataset, batch_size, num_workers, gather_on_cpu=True)
