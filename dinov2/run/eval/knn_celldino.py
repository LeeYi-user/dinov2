...
from dinov2.eval.knn_celldino import get_args_parser as get_knn_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from dinov2.eval.knn_celldino import main as knn_main
...
def main():
    description = "Submitit launcher for k-NN evaluation on models trained with bag of channel strategy or cell dino"
