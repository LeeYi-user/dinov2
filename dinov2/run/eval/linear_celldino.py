...
from dinov2.eval.linear_celldino import get_args_parser as get_linear_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from dinov2.eval.linear_celldino import main as linear_main
...
def main():
    description = "Submitit launcher for DINOv2 linear_celldino evaluation"
    ...
    submit_jobs(Evaluator, args, name="dinov2:linear_celldino")
    return 0
